...
execute if score @s FCP.CP-Num matches 1 run data modify storage fcp: TP set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].CP1
execute if score @s FCP.CP-Num matches 2 run data modify storage fcp: TP set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].CP2
execute if score @s FCP.CP-Num matches 3 run data modify storage fcp: TP set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].CP3
execute if score @s FCP.CP-Num matches 4 run data modify storage fcp: TP set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].CP4
...
execute store success storage fcp: TP.Success byte 1 run data modify storage fcp: Check-UUID.Sorce-C set from entity @s Pos
